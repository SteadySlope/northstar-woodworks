      ...
      <div className="border-b border-white/10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <p className="text-white/70 max-w-2xl mx-auto mb-8 text-lg">
            Every great piece starts with a conversation. Tell us what you have in mind
            and we&apos;ll craft something extraordinary.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center bg-copper text-white px-8 py-3 rounded-md font-medium hover:bg-brass transition-colors"
            >
              Request a Consultation
            </Link>
            <a
              href={`tel:${company.phoneRaw}`}
              className="inline-flex items-center justify-center border border-white/30 text-white px-8 py-3 rounded-md font-medium hover:bg-white/10 transition-colors"
            >
